...
const resources = {
  en: {
    translation: {
      ...
      dosha: {
        heroTitle: 'Find Puja Remedy for Free',
        ...
        requestExpertCallback: 'Request call back from our expert',
        male: 'Male',
        female: 'Female',
        ...
        enterPlace: 'e.g. Jaipur, Mumbai, Varanasi',
        ...
        problemAreaHint: 'Max 100 characters',
      ...
      doshaResults: {
        ...
        whyPresent: 'Why Present',
        whyAbsent: 'Why Absent',
        impact: 'Impact',
  ...
  hi: {
    translation: {
      ...
      dosha: {
        heroTitle: 'मुफ़्त में पूजा उपाय खोजें',
        ...
        requestExpertCallback: 'हमारे विशेषज्ञ से कॉलबैक का अनुरोध करें',
        male: 'पुरुष',
        female: 'महिला',
        ...
        enterPlace: 'उदाहरण: जयपुर, मुंबई, वाराणसी',
        ...
        problemAreaHint: 'अधिकतम 100 अक्षर',
      ...
      doshaResults: {
        ...
        whyPresent: 'क्यों उपस्थित है',
        whyAbsent: 'क्यों अनुपस्थित है',
        impact: 'प्रभाव',
