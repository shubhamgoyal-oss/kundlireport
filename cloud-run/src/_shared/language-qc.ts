import { getLanguagePack, normalizeLanguage } from "./language-packs/index";
import type { LanguagePack, LanguageQcResult, LanguageQcSectionResult, SupportedLanguage } from "./language-packs/types";
